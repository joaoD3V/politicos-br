          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="text-muted-foreground space-y-3">
                ...
                <Link href="https://dadosabertos.camara.leg.br/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-primary hover:underline">
